...
const KNOWN_ABILITY_EFFECTS = new Set([
  ...
  "damageRestedTarget", "exileTargetNonNeutralNonUnifall", "exileAllNonNeutralNonUnifall",
  "grantKeywordsToAllMagicMachines", "damageAllEnemiesAndPushBack", "reviveStructFromDump",
  "buffFriendlyUnitsAtk", "descentEffect", "searchUnitToCostHand", "searchCardToHand", "searchDeckPick",
  ...
  "placeCharmCounters", "placeCharmOnDamageTarget", "verzariaConsumeZeroAtk",
  "charmControlSteal", "highSuccubusForcedAttack", "warMaidenCharmAttackBuff",
  "warMaidenDamageAtkBuff", "verzariaDivineOffer", "dimensionEscapeTactPlay",
  "exileSelfOnDestroyCoreDamage", "exileUnitSilently",
  "unknownWormSummonRest", "unknownWormSummonRestApply", "unknownWormTurnEndShield", "unknownWormTurnEndShieldApply",
  ...
  "tsunataiRitePlay",
  "damageHighestEnemyUnitByOwnAtk",
  "damageAllEnemyUnits",
  "restAttacker",
